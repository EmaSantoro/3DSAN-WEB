...
// Eliminamos el componente Counter y la importación de useEffect/useRef/animate ya que no se usarán
            ...
            <div style={{ maxWidth: '860px', textAlign: 'center', position: 'relative', zIndex: 1 }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'center', gap: 'clamp(2rem, 8vw, 6rem)', flexWrap: 'wrap' }}>
                    {[
                        ...
                        { label: 'Envíos a todo el país', special: true },
                    ].map((stat, i) => (
                        <motion.div
                            key={stat.label}
